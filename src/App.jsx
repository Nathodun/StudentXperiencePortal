            ...
            <div className="max-w-3xl">
              ...
              <div className="mt-8 bg-slate-800/80 border border-slate-700 rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 backdrop-blur-md">
                ...
                <button
                  ...
                  className="flex items-center w-full sm:w-auto bg-amber-600 hover:bg-amber-500 text-white text-xs font-bold px-4 py-2 rounded-lg transition-all text-center whitespace-nowrap shadow-md"
                >
